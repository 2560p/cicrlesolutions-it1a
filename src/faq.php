...
<? include "../components/header.php"; ?>
    <div id="gridContainer">
		...
		<div id="flexBanner">
			<p class="classBannertitle">What is an intranet?</p>
			...
			<p class="classBannertitle">What is the difference between the internet and an intranet?</p>
			<p class="classBannertext">
			...
			<p class="classBannertitle">What is an intranet and an extranet?</p>
			<p class="classBannertext">
			...
			<p class="classBannertitle">What are intranet sites?</p>
			<p class="classBannertext">
			...
			<p class="classBannertitle">What are intranet applications?</p>
			<p class="classBannertext">
			...
			<p class="classBannertitle">What is an intranet portal?</p>
			<p class="classBannertext">
			...
			<p class="classBannertitle">Can an intranet work without the internet?</p>
			<p class="classBannertext">
			...
			<p class="classBannertitle">Can an intranet be accessed remotely?</p>
			<p class="classBannertext">
			...
			<p class="classBannertitle">What does an intranet do?</p>
			<p class="classBannertext">
